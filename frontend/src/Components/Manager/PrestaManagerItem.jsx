...
function PrestaManagerItem({ club,reload }) {
    ...
    return (
        <div className="franchise-card">
            <Link to={`club/${club.id}`} className="franchise-card__visuel">
                <img src={getImage()} alt="sport-image"/>
            </Link>
            <div className="franchise-card__content">
                <Link to={`club/${club.id}`} className="franchise-card__content__details">
                ...
                <button className="primary-button" onClick={() => handleClick(club)}>Modifier</button>
            </div>
