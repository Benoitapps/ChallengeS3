...
class Prestation
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[Groups(['slot:read', 'franchise:read','slot:history:read:collection'])]
    #[ORM\Column]
    private ?int $id = null;

    #[Groups(['slot:read', 'slot:read:collection', 'prestation:write', 'prestation:read', 'coach:read:slots', 'company:read:franchise', 'franchise:read','slot:history:read:collection'])]
